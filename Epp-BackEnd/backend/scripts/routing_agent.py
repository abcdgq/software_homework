...
if __name__ == '__main__':
    # query = "请介绍一下VQVAE的损失函数第二项代表了什么"
    query = "你今天吃了什么"
    paper_title = "Neural Discrete Representation Learning"
    # print(extract_keywords(query))
    # print(classify_question_type(query))
    print(generate_subtasks(paper_title, query))
    print(generate_subtasks_2(paper_title, query))
    # print(generate_fallback_subtasks(query, classify_question_type(query), extract_keywords(query)))